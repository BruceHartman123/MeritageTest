...
var MealViewComponent = (function () {
    function MealViewComponent(globalData, datepipe) {
        ...
        this.totalCalories = this.globalData.getTotalCalories();
        ...
        this.submitModifyForm = function () {
            ...
            if (_this.updCalories == null || _this.updCalories == "") {
            ...
            if (_this.currentUpdateMeal != null) {
                ...
                _this.globalData.addMeal(_this.globalData.currentUser, _this.updMealDesc, _this.updCalories, new Date(_this.updTime), false);
                _this.submitFilterForm();
                _this.showModifyForm = false;
            }
        };
        ...
        this.calcDailyTotals = function () {
            ...
            for (var _i = 0, _a = _this.mealList; _i < _a.length; _i++) {
                var meal = _a[_i];
                var day = _this.getDailyMapKey(meal.time);
            ...
            for (var _b = 0, _c = _this.mealList; _b < _c.length; _b++) {
                var meal = _c[_b];
                var dayValue = dailyMap.get(_this.getDailyMapKey(meal.time));
                meal.underDaily = (dayValue > _this.totalCalories);
            }
        };
        this.getDailyMapKey = function (date) {
